...
def get_args():
    ...
    parser.add_argument('--target_layer', type=str, default='conv1')
...
if __name__ == '__main__':
    args = get_args()
    model = AlexNet()
    alexnet_snapshot = '/vol/ccnlab-scratch1/katmul/reconv/featurematching_models/alexgray_model_iter_65000'  #model_iter_1135000 alexgray_model_iter_20000
    serializers.load_npz(alexnet_snapshot, model)
    ...
    for filter_index in range(filter_num):
        img = np.random.random((1, 1, img_height, img_width)) * 0.08 - 0.5
