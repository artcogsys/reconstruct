...
def load_gray_images(image_dir):
    return _load_images(image_dir, convert_to="L")

def load_gray_images_with_embeddings(image_dir):
    return _load_images(image_dir, convert_to="L")


def load_rgb_images(image_dir):
    return _load_images(image_dir, convert_to="RGB")


def load_rgba_images(image_dir):
    return _load_images(image_dir, convert_to="RGBA")
