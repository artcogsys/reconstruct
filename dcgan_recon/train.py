...
def main():
    ...
    if debug: 
        images = load_gray_images("/vol/ccnlab-scratch1/katmul/reconv/gentrain_imgs/dim64x64glove_debug/")
    else:
        images = load_gray_images("/vol/ccnlab-scratch1/katmul/reconv/gentrain_imgs/dim64x64glove/")
